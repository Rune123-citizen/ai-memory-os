...
def parse_query(query: str) -> dict:
    ...
    prompt = f"""You are a precise query extraction engine. Analyze this user query.
Query: "{query}"
...
3. "time_range": Any time expression mentioned (e.g., "today", "yesterday", "last week"). Null if none.
